...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"TH, Detailed location information contact with person","Location of exposure","Text","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"TH, Detailed location information exposure to animal market","Location of exposure","Text","Misc",false);
